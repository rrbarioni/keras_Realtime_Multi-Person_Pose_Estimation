...
from model.model_simple_baselines_egocap import get_training_model
from training.optimizers import MultiSGD
from training.dataset_simple_baselines_egocap import get_dataflow, batch_dataflow
...
if __name__ == '__main__':
    ...
    annot_path_train = os.path.join(curr_dir, '../../EgoCap-Dataset/dataset.txt')
    img_dir_train = os.path.join(curr_dir, '../../EgoCap-Dataset/images/')

    # get dataflow of samples from training set and validation set (we use validation set for training as well)

    egocap_data_train = EgoCapDataPaths(
        annot_path=annot_path_train,
        img_dir=img_dir_train
    )
    df = get_dataflow([egocap_data_train])
