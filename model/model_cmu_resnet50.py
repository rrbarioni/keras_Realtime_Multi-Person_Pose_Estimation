...
def get_training_model(weight_decay):
    ...
    # VGG
    stage0_out = resnet50_block(img_normalized, weight_decay)
...
def get_testing_model():
    ...
    # VGG
    stage0_out = resnet50_block(img_normalized, None)
    ...
    # stage t >= 2
    stageT_branch1_out = stage1_branch1_out
    stageT_branch2_out = stage1_branch2_out
    for sn in range(2, stages + 1):
